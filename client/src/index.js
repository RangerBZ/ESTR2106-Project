...
class App extends React.Component {
    ...
    render(){
      ...
      const headStyle={
        backgroundColor:'rgb(192, 208, 255)',   
        textAlign:"center",
        color:"rgb(0,120,255)",
            ...
            <BrowserRouter>
                ...
                <h2 style={headStyle}>
                  ...
                  <ul style={routerStyle}>
                        ...
                        <li>{' '}
                        <Link to="/favourites" style={linkStyle} className='link'><i className="bi bi-hearts"></i> Favourites</Link>{' '}
                        </li>
                        <li>{' '}
                        <Link to="/booking" style={linkStyle} className='link'><i className="bi bi-calendar-event"></i> My event</Link>{' '}
                        </li>
                        <li>{' '}
                        <Link to="/others" style={linkStyle} className='link'><i class="bi bi-lightbulb"></i> No idea?</Link>{' '}
                        </li>{' '}
                        {userRole && (<li>{' '}
                        <Link to="/admin" style={linkStyle} className='link'><i className="bi bi-database"></i> Manage database</Link>
                        </li>)}
